...
doc += `> AUTO-GENERATED by \`scripts/generate-llms-full.mjs\` on ${new Date().toISOString().slice(0, 10)} — do not edit by hand, regenerate with \`node scripts/generate-llms-full.mjs\`.\n\n`;
doc += `> Complete catalog of ${components.length} zero-dependency React 19 + Tailwind CSS 4 components with Ticket Stub aesthetic.\n\n`;
...
doc += "## Component Catalog (" + components.length + " Components)\n\n";
