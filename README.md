...
| [`trend-badge`](https://ui.bigbullapp.com/docs/trend-badge) | Trend Badge | Stamped trend badge with direction arrow, velocity levels and live pulse. |
| [`meter`](https://ui.bigbullapp.com/docs/meter) | Meter | Gauge meter with zones, ticks and status readout. |
| [`badge-ribbon`](https://ui.bigbullapp.com/docs/badge-ribbon) | Badge Ribbon | Rosette award ribbon with rank and color themes. |
...
| [`callout`](https://ui.bigbullapp.com/docs/callout) | Callout | Dismissible notice box with tone variants. |
