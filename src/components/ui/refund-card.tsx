...
const STATUS = {
  ...
  approved: { label: "Onaylandı", cls: "border-sky-500/50 bg-sky-500/10 text-sky-600" },
  rejected: { label: "Reddedildi", cls: "border-destructive/50 bg-destructive/10 text-destructive" },
  completed: { label: "Tamamlandı", cls: "border-emerald-500/50 bg-emerald-500/10 text-emerald-600" },
};

/** İade kartı: durum + tutar + sebep. */
